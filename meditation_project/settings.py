...
# ALLOWED_HOSTS = []
ALLOWED_HOSTS = [
    '192.168.2.1010',  # Replace with your actual IP
    '192.168.1.5',      # Your local IP (adjust accordingly)
    'localhost',
    '127.0.0.1',
    '*'  # Allow all hosts (for testing only, not recommended for production)
]
...
ROOT_URLCONF = 'meditation_project.urls'
...
WSGI_APPLICATION = 'meditation_project.wsgi.application'
